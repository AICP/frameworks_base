...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.OMNI_DEVICE_FEATURE_SETTINGS, ANY_STRING_VALIDATOR);
        VALIDATORS.put(System.OMNI_LONG_PRESS_POWER_TORCH, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_ADVANCED_REBOOT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_MONET_DISABLE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_SHOW_BATTERY_IMAGE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_LOCKSCREEN_WEATHER_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_BACK_GESTURE_HEIGHT, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_STATUS_BAR_ALARM, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_ENABLE_TASKBAR, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_NAVIGATION_BAR_ARROW_KEYS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_GESTURE_HANDLE_HIDE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_GESTURE_HANDLE_SMALL, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_ALLOW_ON_DND, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_LOW_BLINKING, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_LOW_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_MEDIUM_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_FULL_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_REALLY_FULL_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_FAST_BATTERY_LIGHT_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_FAST_CHARGING_LED_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_BATTERY_LIGHT_ONLY_FULLY_CHARGED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_QS_LAYOUT_COLUMNS_LANDSCAPE, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.OMNI_QS_LAYOUT_COLUMNS, ANY_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(System.OMNI_LOW_BATTERY_BEHAVIOR, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_DOZE_ON_CHARGE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_STATUS_BAR_BT_BATTERY, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_LOCKSCREEN_CLOCK_COLORED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_VIBRATE_ON_CONNECT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_VIBRATE_ON_CALLWAITING, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_VIBRATE_ON_DISCONNECT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_LOCKSCREEN_ALARM_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.OMNI_LOCKSCREEN_DND_ENABLED, BOOLEAN_VALIDATOR);
