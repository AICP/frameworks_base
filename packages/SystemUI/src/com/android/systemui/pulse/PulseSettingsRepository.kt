...
class PulseSettingsRepository(private val context: Context) {
    ...
    companion object {
        ...
        private const val PULSE_MORE_SCREEN_ENABLED = Settings.Secure.MORE_SCREEN_PULSE_ENABLED
        ...
        private const val DEFAULT_MORE_SCREEN_ENABLED = false
    ...
    private var cachedMoreScreenEnabled: Boolean? = null
    ...
    fun startObserving() {
        ...
        listOf(
            ...
            Settings.Secure.getUriFor(PULSE_MORE_SCREEN_ENABLED),
    ...
    fun isPulseMoreScreenEnabled(): Boolean {
        if (cachedMoreScreenEnabled == null) {
            cachedMoreScreenEnabled = getSecureSetting(PULSE_MORE_SCREEN_ENABLED, DEFAULT_MORE_SCREEN_ENABLED)
        }
        return cachedMoreScreenEnabled!!
    }
