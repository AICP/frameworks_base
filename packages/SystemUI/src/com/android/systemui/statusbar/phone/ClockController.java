...
public class ClockController {
    ...
    public ClockController(Context context, View statusBar) {
        ...
        Uri iconHideList = Settings.System.getUriFor(Settings.System.STATUS_BAR_CLOCK);
        ...
        ContentObserver contentObserver = new ContentObserver(null) {
            ...
            public void onChange(boolean selfChange, @Nullable Uri uri) {
                if (iconHideList.equals(uri)) {
                    mDenyListed = Settings.System.getInt(mContext.getContentResolver(),
                            Settings.System.STATUS_BAR_CLOCK, 1) != 1;
                } else if (statusBarClock.equals(uri)) {
                    mClockPosition = Settings.System.getInt(mContext.getContentResolver(),
                            Settings.System.STATUS_BAR_CLOCK_POSITION, CLOCK_POSITION_LEFT);
                }
                updateActiveClock();
            }
        };
