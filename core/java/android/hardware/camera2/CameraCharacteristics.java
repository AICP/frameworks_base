...
public final class CameraCharacteristics extends CameraMetadata<CameraCharacteristics.Key<?>> {
    ...
    public <T> T get(Key<T> key) {
        if (key == INFO_SUPPORTED_HARDWARE_LEVEL) {
            boolean isOnePlusCameraHack = Resources.getSystem().getBoolean(
                    com.android.internal.R.bool.config_enableOnePlusCameraHack);
            String packageName = ActivityThread.currentOpPackageName();
            if (isOnePlusCameraHack && packageName.equals("com.oneplus.camera")) {
