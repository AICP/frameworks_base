...
public class CPUInfoManager implements CoreStartable, AicpSettingsService.AicpSettingsObserver {
    ...
    public void onBootCompleted() {
        ...
        Dependency.get(AicpSettingsService.class).addIntObserver(this, OMNI_SHOW_CPU_OVERLAY);
    }
