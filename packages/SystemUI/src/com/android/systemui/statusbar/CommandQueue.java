...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_KILL_FOREGROUND_APP         = 55 << MSG_SHIFT;
    private static final int MSG_SCREEN_PINNING_STATE_CHANGED  = 56 << MSG_SHIFT;
    private static final int MSG_LEFT_IN_LANDSCAPE_STATE_CHANGED  = 57 << MSG_SHIFT;
