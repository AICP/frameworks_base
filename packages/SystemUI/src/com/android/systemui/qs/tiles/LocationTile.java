...
public class LocationTile extends QSTileImpl<BooleanState> {
    ...
    private class LocationDetailAdapter implements DetailAdapter {
        ...
        @Override
        public int getMetricsCategory() {
            return MetricsEvent.AICP_TILE_LOCATION_DETAIL;
        }
        ...
        public void setToggleState(boolean state) {
            ...
            if (!state) {
                mController.setLocationEnabled(state ? SENSORS_ONLY : OFF);
                showDetail(false);
            }
        }
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            ...
            mLastState = mController.getCurrentMode();
            ...
            public void onSelected(final Object value, boolean fromClick) {
                if (value != null && mButtons.isShown()) {
                    ...
                    if (fromClick) {
                        ...
                        mController.setLocationEnabled(mLastState);
                        refresh(mLastState);
                    }
                }
            }
