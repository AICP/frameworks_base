...
public class QuickQSPanel extends QSPanel {
    ...
    public int DEFAULT_MIN_TILES = getResources().getInteger(R.integer.quick_qs_panel_max_columns) * 2;
    ...
    static class QQSSideLabelTileLayout extends SideLabelTileLayout {
        ...
        public int getResourceColumns() {
            int columns = Math.min(DEFAULT_MAX_TILES,
                    getResources().getInteger(R.integer.quick_settings_num_columns));
