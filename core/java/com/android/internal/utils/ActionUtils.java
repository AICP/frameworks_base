...
public final class ActionUtils {
    ...
    public static final String PACKAGE_SETTINGS = "com.aicp.extras";
    public static final String CLASS_NAME_ICON_PICKER_GRID_ACTIVITY = "com.aicp.extras.smartnav.IconPackGridActivity";
    public static final String CLASS_NAME_ICON_PICKER_ACTIVITY = "com.aicp.extras.smartnav.IconPickerActivity";
    public static final String CLASS_NAME_ACTION_EDIT = "com.aicp.extras.smartnav.ActionPickerDialogActivity";
    public static final String CLASS_NAME_GALLERY_PICKER = "com.aicp.extras.smartnav.IconPickerGallery";
