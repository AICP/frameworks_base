...
public abstract class UdfpsIconDrawable extends Drawable {
    ...
    private final String udfpsResourcesPackage = "com.aicp.overlay.udfps.icons";
    ...
    private void init() {
        if (PackageUtils.isPackageInstalled(mContext, udfpsResourcesPackage)) {
            try {
                ...
                // if value is invalid, reset it to 1 to prevent boot failure
