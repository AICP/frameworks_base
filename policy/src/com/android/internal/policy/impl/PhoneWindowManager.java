...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.VOLUME_KEYS_RINGER_MODE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.NON_INTRUSIVE_INCALL), false, this,
                    UserHandle.USER_ALL);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mCallInBackground = Settings.AOKP.getInt(resolver,
                    Settings.AOKP.NON_INTRUSIVE_INCALL, 1) == 1;
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        // If we think we might have a volume down & power/wolume up key chord on the way
