    ...
    public static int getLayoutDirectionFromLocale(Locale locale) {
        ...
        if (locale != null && !locale.equals(Locale.ROOT)) {
            ...
            if (scriptSubtag.equalsIgnoreCase(ARAB_SCRIPT_SUBTAG) ||
                ...
                //If forcing RTL layout mode and language is RTL, return LTR as default, else RTL
                return mirror ? View.LAYOUT_DIRECTION_LTR : View.LAYOUT_DIRECTION_RTL;
            }
        }
        // If forcing RTL layout mode and language is LTR, return RTL as default, else LTR
