...
public class BurnInProtectionController {
    ...
    public BurnInProtectionController(Context context, StatusBar statusBar,
        ...
        mSwiftEnabled = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_statusBarBurnInProtection);
        ...
        mShiftInterval = (long) mContext.getResources().getInteger(
                com.android.internal.R.integer.config_shift_interval);
    }
