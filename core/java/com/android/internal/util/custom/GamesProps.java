...
public class GamesProps {
    ...
    private static final Map<String, Object> propsToChangeR11;
    private static final String[] packagesToChangeR11 = {
    ...
    static {
        ...
        propsToChangeR11 = new HashMap<>();
        propsToChangeR11.put("MODEL", "R11 Plus");
        propsToChangeR11.put("MANUFACTURER", "Oppo");
    ...
    public static void setProps(String packageName) {
        ...
        if (Arrays.asList(packagesToChangeR11).contains(packageName)){
            if (DEBUG){
                Log.d(TAG, "Defining props for: " + packageName);
            }
            for (Map.Entry<String, Object> prop : propsToChangeR11.entrySet()) {
                String key = prop.getKey();
                Object value = prop.getValue();
                setPropValue(key, value);
            }
