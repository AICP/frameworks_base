...
public class AppCircleSidebar extends TriggerOverlayView implements PackageAdapter.OnCircleItemClickListener,
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            final ContentResolver resolver = mContext.getContentResolver();
            setAppBarVisibility(Settings.System.getIntForUser(resolver,
            ...
            int width = Settings.System.getInt(resolver,
                    Settings.System.APP_CIRCLE_BAR_TRIGGER_WIDTH, 25);
            if (mTriggerWidth != width) {
                setTriggerWidth(width);
            }

            setTopPercentage(Settings.System.getInt(resolver,
                    Settings.System.APP_CIRCLE_BAR_TRIGGER_TOP, 0) / 100f);
            setBottomPercentage(Settings.System.getInt(resolver,
                    Settings.System.APP_CIRCLE_BAR_TRIGGER_HEIGHT, 100) / 100f);

            if (Settings.System.getInt(resolver,
                    Settings.System.APP_CIRCLE_BAR_SHOW_TRIGGER, 0) == 1) {
                showTriggerRegion();
            } else {
                hideTriggerRegion();
            }
