...
public class DozeTriggers implements DozeMachine.Part {
    ...
    public void onScreenState(int state) {
        ...
        boolean inDesiredState = (state == Display.STATE_DOZE
                || state == Display.STATE_DOZE_SUSPEND
                || state == Display.STATE_OFF);
        mDozeSensors.setProxListening(mWantProx && inDesiredState);
        if (inDesiredState && mConfig.deviceHasWeirtdDtSensor() && mWantTouchScreenSensors) {
