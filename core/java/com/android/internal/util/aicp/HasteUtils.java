...
/**
 * Helper functions for uploading to https://haste.aicp-rom.com
 */
public final class HasteUtils {
    private static final String TAG = "HasteUtils";
    private static final String BASE_URL = "https://haste.aicp-rom.com";
    ...
    /**
     * Uploads {@code content} to aicp haste
     *
     * @param content the content to upload to aicp haste
                ...
                try {
                    ...
                    try {
                        ...
                        if (!key.isEmpty()) {
                            ...
                            String msg = "Failed to upload to aicp haste: No key retrieved";
                            callback.onFail(msg, new HasteException(msg));
                        }
                    } finally {
                        urlConnection.disconnect();
                    }
                } catch (Exception e) {
                    callback.onFail("Failed to upload to aicp haste", e);
                }
            }
        });
    }
    ...
    private static Handler getHandler() {
        if (handler == null) {
            HandlerThread handlerThread = new HandlerThread("hasteThread");
