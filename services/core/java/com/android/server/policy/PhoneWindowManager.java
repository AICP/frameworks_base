...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.DISABLE_INCALL_HOME), false, this,
                    UserHandle.USER_ALL);
            updateSettings();
        }
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mCameraSleepOnRelease = Settings.System.getIntForUser(
                    resolver, Settings.System.CAMERA_SLEEP_ON_RELEASE, 0,
                    UserHandle.USER_CURRENT) == 1;
            mCameraLaunch = Settings.System.getIntForUser(
                    resolver, Settings.System.CAMERA_LAUNCH, 0,
                    UserHandle.USER_CURRENT) == 1;
            ...
            mDisableIncallHome = Settings.System.getIntForUser(resolver,
                    Settings.System.DISABLE_INCALL_HOME, 0,
                    UserHandle.USER_CURRENT) != 0;
        }
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (!down) {
                ...
                // If an incoming call is ringing and mDisableIncallHome=true, HOME is totally disabled.
                TelecomManager telecomManager = getTelecommService();
