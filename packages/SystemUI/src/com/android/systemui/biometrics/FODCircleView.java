...
public class FODCircleView extends ImageView implements ConfigurationListener, TunerService.Tunable {
    ...
    private IFingerprintInscreenCallback mFingerprintInscreenCallback =
        ...
        public void onFingerUp() {
            ...
            if (mSupportsFodGesture && mFodGestureEnable && mPressPending) {
                mPressPending = false;
            }
        }
    };
    ...
    private KeyguardUpdateMonitorCallback mMonitorCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onScreenTurnedOff() {
            ...
            if (mSupportsFodGesture && mFodGestureEnable){
                hideCircle();
            }else{
                hide();
            }
        ...
        public void onScreenTurnedOn() {
            if ((!mSupportsFodGesture || !mFodGestureEnable) && mUpdateMonitor.isFingerprintDetectionRunning()) {
                show();
            }
            if (mSupportsFodGesture && mFodGestureEnable && mPressPending) {
                mHandler.post(() -> showCircle());
    ...
    public void show() {
        ...
        if ((!mSupportsFodGesture || !mFodGestureEnable) && !mUpdateMonitor.isScreenOn()) {
