...
fun BuildNumber(
    ...
    val qsFooterTextEnabledValue = getQsFooterTextShow(context)

    val qsFooterTextEnabled = remember(qsFooterTextEnabledValue) {
        qsFooterTextEnabledValue == 1
    }

    if (qsFooterTextEnabled) {
        val haptics = LocalHapticFeedback.current
        val copyToClipboardActionLabel = stringResource(id = R.string.copy_to_clipboard_a11y_action)


        val qsFooterText = remember {
